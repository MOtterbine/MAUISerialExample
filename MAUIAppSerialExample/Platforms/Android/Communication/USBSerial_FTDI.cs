...
public class USBSerial_FTDI : AndroidUSB_Base, IDevicesService, ICommunicationDevice, ISerialDevice
{
    ...
    //public List<FlowControl> getSupportedFlowControl()
    //{
    //    return FlowControl. el yiel { FlowControl.NONE, FlowControl.RTS_CTS, FlowControl.DTR_DSR, FlowControl.XON_XOFF_INLINE};
    //}
